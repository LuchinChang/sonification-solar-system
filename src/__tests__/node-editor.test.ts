...
describe('node-editor graph', () => {
  ...
  it('openEditor is a toggle for the same sweeper id', () => {
    ...
    const fakeSweeper = { id: 7, type: 'sweeper', sweepColor: '#C084FC' } as unknown as CanvasShape;
  ...
  it('openEditor repoints when called for a different sweeper', () => {
    const sweepers: Record<number, CanvasShape> = {
      7: { id: 7, type: 'sweeper', sweepColor: '#C084FC' } as unknown as CanvasShape,
      9: { id: 9, type: 'sweeper', sweepColor: '#E8A050' } as unknown as CanvasShape,
    };
